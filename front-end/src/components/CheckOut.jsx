          ...
          <div className="min-w-0 flex-1 space-y-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="relative w-full">
                      <input
                        type="text"
                        id="phone-input"
                        className="focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 z-20 block w-full rounded-e-lg border border-s-0 border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400"
            ...
            <div>
              ...
              <div className="flex max-w-md items-center gap-4">
                ...
                <button
                  type="button"
                  className="rounded-md bg-teal-500 px-3 py-2 text-white hover:bg-teal-700"
                >
                  Apply
                </button>
              </div>
